...
class TabBarViewController: UITabBarController {
    override func viewDidLoad() {
        ...
        if #available(iOS 11.0, *) {
            ...
            levelNav.tabBarItem.imageInsets = .init(top: topBottom, left: 0, bottom: -topBottom, right: 0)
            levelNav.tabBarItem.titlePositionAdjustment = .init(horizontal: 0, vertical: topBottom)
            scoreboardNav.tabBarItem.imageInsets = .init(top: topBottom, left: 0, bottom: -topBottom, right: 0)
            scoreboardNav.tabBarItem.titlePositionAdjustment = .init(horizontal: 0, vertical: topBottom)
            settingNav.tabBarItem.imageInsets = .init(top: topBottom, left: 0, bottom: -topBottom, right: 0)
